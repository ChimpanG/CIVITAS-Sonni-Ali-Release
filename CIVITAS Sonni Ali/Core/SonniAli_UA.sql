...
VALUES	('TRAIT_LEADER_CVS_SONNI_ALI_UA',				'KIND_TRAIT'	),
		...
		('MODTYPE_CVS_SONNI_ALI_UA_ERA_SCORE',			'KIND_MODIFIER'	),
...
VALUES	('TRAIT_LEADER_CVS_SONNI_ALI_UA',	'MODIFIER_CVS_SONNI_ALI_UA_GOLDEN_COMBAT'	),
		('TRAIT_LEADER_CVS_SONNI_ALI_UA',	'MODIFIER_CVS_SONNI_ALI_UA_WAR_SCORE'		),
...
VALUES	('MODTYPE_CVS_SONNI_ALI_UA_COMBAT_STRENGTH',	'COLLECTION_PLAYER_COMBAT',	'EFFECT_ADJUST_PLAYER_STRENGTH_MODIFIER'			),
		('MODTYPE_CVS_SONNI_ALI_UA_ERA_SCORE',			'COLLECTION_OWNER',			'EFFECT_ADJUST_PLAYER_ERA_SCORE_PER_PRIDE_MOMENT'	),
...
VALUES	('MODIFIER_CVS_SONNI_ALI_UA_GOLDEN_COMBAT',		'MODTYPE_CVS_SONNI_ALI_UA_COMBAT_STRENGTH',		'REQSET_CVS_SONNI_ALI_UA_GOLDEN_AGE',	'REQSET_CVS_SONNI_ALI_UA_NOT_GOLDEN_AGE'	),
		('MODIFIER_CVS_SONNI_ALI_UA_WAR_SCORE',			'MODTYPE_CVS_SONNI_ALI_UA_ERA_SCORE',			NULL,									'REQSET_CVS_SONNI_ALI_UA_AT_WAR'			),
...
VALUES	('MODIFIER_CVS_SONNI_ALI_UA_GOLDEN_COMBAT',	'Amount',					5				),
		('MODIFIER_CVS_SONNI_ALI_UA_WAR_SCORE',		'MinScore',					1				),
		('MODIFIER_CVS_SONNI_ALI_UA_WAR_SCORE',		'Amount',					1				),
...
VALUES	('REQSET_CVS_SONNI_ALI_UA_AT_WAR',			'REQUIREMENTSET_TEST_ALL'	),
		('REQSET_CVS_SONNI_ALI_UA_GOLDEN_AGE',		'REQUIREMENTSET_TEST_ALL'	),
...
VALUES	('REQSET_CVS_SONNI_ALI_UA_AT_WAR',			'REQ_CVS_SONNI_ALI_UA_AT_WAR'			),
		('REQSET_CVS_SONNI_ALI_UA_GOLDEN_AGE',		'REQ_CVS_SONNI_ALI_UA_GOLDEN_AGE'		),
...
VALUES	('REQ_CVS_SONNI_ALI_UA_AT_WAR',			'REQUIREMENT_PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS',	1		),
		('REQ_CVS_SONNI_ALI_UA_GOLDEN_AGE',		'REQUIREMENT_PLAYER_HAS_GOLDEN_AGE',				0		),
